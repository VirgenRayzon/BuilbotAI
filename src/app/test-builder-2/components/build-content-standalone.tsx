...
import { BuildItemStandalone } from "./build-item-standalone";
import { BottleneckMeter } from "@/components/build/bottleneck-meter";
...
export function BuildContentStandalone({
  build,
  onRemovePart,
  onCategorySelect,
  activeFilter,
