...
export function CanvasText({
  ...
  useEffect(() => {
    ...
    const updateDimensions = () => {
      ...
      // Add a small buffer for italics and canvas rendering
      const buffer = 30;
      setDimensions({
        width: Math.ceil(rect.width) + buffer,
  ...
  return (
    ...
    >
      <span
        ...
        aria-hidden="true"
      />
      <span ref={textRef} className="invisible absolute pointer-events-none whitespace-nowrap leading-none" aria-hidden="true">
        {text}
      </span>
      <canvas
        ref={canvasRef}
