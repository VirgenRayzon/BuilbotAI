...
export function SalesVisualizer({ orderCount }: SalesVisualizerProps) {
    ...
    return (
        <div className="w-full h-[400px] relative rounded-3xl overflow-hidden border border-border bg-card/20 backdrop-blur-sm transition-colors group">
            <div className="absolute top-6 left-6 z-10">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-headline font-bold uppercase tracking-tighter text-foreground">
                        Syncing Sales Data...
                    </span>
                </div>
            </div>
            ...
            <div className="absolute bottom-6 right-6 text-right z-10">
                <p className="text-[40px] font-headline font-bold leading-none tracking-tighter text-foreground">
                    {orderCount ?? 0}
                </p>
