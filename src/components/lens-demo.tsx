...
export function LensDemo() {
  ...
  return (
    <div>
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10 border border-white/5">
        <Rays />
        <Beams />
        <div className="relative z-10">
          ...
          >
            <h2 className="text-white text-2xl text-left font-bold font-headline uppercase">
              Apple Vision Pro
            </h2>
            <p className="text-neutral-400 text-left mt-4 text-sm font-medium leading-relaxed">
